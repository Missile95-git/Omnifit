...
const ROUTINE = {
  ...
  legs: {
    ...
    exercises: [
      ...
      { id:'cr',  name:'Seated Calf Raise',            equip:'Flat bench + 10kg DB',      sets:4, reps:'15–20', knee:'safe', note:'Sit on bench, place 10kg DB on knee, rise on toes fully. Slow lower. Knee-friendly.',                                                                                      video:'https://www.youtube.com/watch?v=-M4-G8p1fCI' },
